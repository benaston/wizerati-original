...
//          'public/stylesheets/application/wizerati-style-cube.css',
      ...
      escapeAngleBracketPercent: {
        ...
        options: {
          patterns: [
            {
              match: 'javascript',
              replacement: '<%= grunt.file.read("public/javascripts/'+ grunt.file.readJSON('package.json').name +'.min.js") %>'
            }
          ]
        },
        files: [
          {src: ['view-templates/_index-css-injected.ejs'], dest: 'view-templates/_index-javascript-injected.ejs'}
        ]
        ...
        files: [
          {src: ['view-templates/_index-javascript-injected.ejs'], dest: 'view-templates/_index-warning-injected.ejs'}
        ]
      },injectBuildNumber: {
        options: {
          patterns: [
        ...
        files: [
          {src: ['view-templates/_index-warning-injected.ejs'], dest: 'view-templates/_index-build-injected.ejs'}
        ]
  ...
  grunt.registerTask('default', ['concat', 'uglify', 'cssUrlEmbed', 'cssmin', 'replace:injectEditWarningIntoHead', 'replace:escapeAngleBracketPercent', 'replace:injectCssIntoHead', 'replace:injectJavaScriptIntoHead', 'replace:injectBuildNumber', 'replace:correctForReplaceTaskBug']);
};
